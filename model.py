...
def EnhanceNet(input_L, input_R, channel=64, kernel_size=3):
...
class lowlight_enhance(object):
    def __init__(self, sess):
        ...
        I_delta = EnhanceNet(I_low, R_low)
        ...
        self.var_Relight = [var for var in tf.trainable_variables() if 'EnhanceNet' in var.name]
    ...
    def test(self, test_low_data, test_high_data, test_low_data_names, save_dir, decom_flag):
        ...
        load_model_status_Relight, _ = self.load(self.saver_Relight, './model/Enhance')
